...
__export(index_exports, {
  ...
  NDKEvent: () => NDKEvent,
  NDKFedimintMint: () => NDKFedimintMint,
  NDKFilterValidationMode: () => NDKFilterValidationMode,
  NDKFollowPack: () => NDKFollowPack,
  NDKHighlight: () => NDKHighlight,
  NDKImage: () => NDKImage,
  NDKInterestList: () => NDKInterestList,
  NDKKind: () => NDKKind,
  NDKList: () => NDKList,
  NDKListKinds: () => NDKListKinds,
  NDKMintRecommendation: () => NDKMintRecommendation,
  ...
  NDKRelayFeedList: () => NDKRelayFeedList,
  ...
  NDKUser: () => NDKUser,
  NDKVideo: () => NDKVideo,
  NDKVoiceMessage: () => NDKVoiceMessage,
  NDKVoiceReply: () => NDKVoiceReply,
  NDKWiki: () => NDKWiki,
  ...
  NutzapValidationCode: () => NutzapValidationCode,
  NutzapValidationSeverity: () => NutzapValidationSeverity,
  ...
  filterEphemeralKindsFromFilter: () => filterEphemeralKindsFromFilter,
  filterFingerprint: () => filterFingerprint,
  filterForCache: () => filterForCache,
  ...
  isValidEventId: () => isValidEventId,
  isValidHex64: () => isValidHex64,
  isValidNip05: () => isValidNip05,
...
var NDKDVMJobFeedback = class _NDKDVMJobFeedback extends NDKEvent {
  static kind = 7e3 /* DVMJobFeedback */;
...
var NDKDVMRequest = class _NDKDVMRequest extends NDKEvent {
  static kind = 5e3 /* DVMReqTextExtraction */;
  static kinds = [
    5e3 /* DVMReqTextExtraction */,
    5001 /* DVMReqTextSummarization */,
    5002 /* DVMReqTextTranslation */,
    5050 /* DVMReqTextGeneration */,
    5100 /* DVMReqImageGeneration */,
    5250 /* DVMReqTextToSpeech */,
    5300 /* DVMReqDiscoveryNostrContent */,
    5301 /* DVMReqDiscoveryNostrPeople */,
...
var nip49 = __toESM(require("nostr-tools/nip49"));
...
var NDKList = class _NDKList extends NDKEvent {
  _encryptedTags;
  static kind = 30001 /* CategorizedBookmarkList */;
  static kinds = [
    30001 /* CategorizedBookmarkList */,
    10004 /* CommunityList */,
    10050 /* DirectMessageReceiveRelayList */,
  ...
  get title() {
    ...
    if (this.kind === 10012 /* RelayFeedList */) {
      return "Relay Feeds";
    }
...
// src/events/kinds/nutzap/validation.ts
...
var SEVERITY_MAP = {
  ["NO_PROOFS" /* NO_PROOFS */]: "ERROR" /* ERROR */,
  ["INVALID_PROOF_COUNT" /* INVALID_PROOF_COUNT */]: "ERROR" /* ERROR */,
  ["MULTIPLE_RECIPIENTS" /* MULTIPLE_RECIPIENTS */]: "ERROR" /* ERROR */,
  ["NO_RECIPIENT" /* NO_RECIPIENT */]: "ERROR" /* ERROR */,
  ["MULTIPLE_MINTS" /* MULTIPLE_MINTS */]: "ERROR" /* ERROR */,
  ["NO_MINT" /* NO_MINT */]: "ERROR" /* ERROR */,
  ["MULTIPLE_EVENT_TAGS" /* MULTIPLE_EVENT_TAGS */]: "ERROR" /* ERROR */,
  ["MALFORMED_PROOF_SECRET" /* MALFORMED_PROOF_SECRET */]: "ERROR" /* ERROR */,
  ["MISSING_EVENT_TAG_IN_PROOF" /* MISSING_EVENT_TAG_IN_PROOF */]: "WARNING" /* WARNING */,
  ["MISMATCHED_EVENT_TAG_IN_PROOF" /* MISMATCHED_EVENT_TAG_IN_PROOF */]: "WARNING" /* WARNING */,
  ["MISSING_SENDER_TAG_IN_PROOF" /* MISSING_SENDER_TAG_IN_PROOF */]: "WARNING" /* WARNING */,
  ["MISMATCHED_SENDER_TAG_IN_PROOF" /* MISMATCHED_SENDER_TAG_IN_PROOF */]: "WARNING" /* WARNING */,
  ["NO_EVENT_TAG_IN_EVENT" /* NO_EVENT_TAG_IN_EVENT */]: "WARNING" /* WARNING */
};
var ERROR_MESSAGES = {
  ["NO_PROOFS" /* NO_PROOFS */]: "Nutzap must contain at least one proof",
  ["INVALID_PROOF_COUNT" /* INVALID_PROOF_COUNT */]: "Invalid proof count",
  ["MULTIPLE_RECIPIENTS" /* MULTIPLE_RECIPIENTS */]: "Nutzap must have exactly one recipient (p tag)",
  ["NO_RECIPIENT" /* NO_RECIPIENT */]: "Nutzap must have a recipient (p tag)",
  ["MULTIPLE_MINTS" /* MULTIPLE_MINTS */]: "Nutzap must specify exactly one mint (u tag)",
  ["NO_MINT" /* NO_MINT */]: "Nutzap must specify a mint (u tag)",
  ["MULTIPLE_EVENT_TAGS" /* MULTIPLE_EVENT_TAGS */]: "Nutzap must have at most one event tag (e tag)",
  ["MALFORMED_PROOF_SECRET" /* MALFORMED_PROOF_SECRET */]: "Proof secret is malformed and cannot be parsed",
  ["MISSING_EVENT_TAG_IN_PROOF" /* MISSING_EVENT_TAG_IN_PROOF */]: "Proof secret missing 'e' tag for replay protection",
  ["MISMATCHED_EVENT_TAG_IN_PROOF" /* MISMATCHED_EVENT_TAG_IN_PROOF */]: "Proof secret 'e' tag does not match event being zapped",
  ["MISSING_SENDER_TAG_IN_PROOF" /* MISSING_SENDER_TAG_IN_PROOF */]: "Proof secret missing 'P' tag for sender verification",
  ["MISMATCHED_SENDER_TAG_IN_PROOF" /* MISMATCHED_SENDER_TAG_IN_PROOF */]: "Proof secret 'P' tag does not match sender pubkey",
  ["NO_EVENT_TAG_IN_EVENT" /* NO_EVENT_TAG_IN_EVENT */]: "Nutzap event missing 'e' tag (recommended for replay protection)"
};
...
var NDKNutzap = class _NDKNutzap extends NDKEvent {
  ...
  validateNIP61() {
    ...
    if (this.proofs.length === 0) {
      issues.push(createValidationIssue("NO_PROOFS" /* NO_PROOFS */));
    }
    if (pTagCount === 0) {
      issues.push(createValidationIssue("NO_RECIPIENT" /* NO_RECIPIENT */));
    } else if (pTagCount > 1) {
      issues.push(createValidationIssue("MULTIPLE_RECIPIENTS" /* MULTIPLE_RECIPIENTS */));
    }
    if (mintTagCount === 0) {
      issues.push(createValidationIssue("NO_MINT" /* NO_MINT */));
    } else if (mintTagCount > 1) {
      issues.push(createValidationIssue("MULTIPLE_MINTS" /* MULTIPLE_MINTS */));
    }
    if (eTagCount > 1) {
      issues.push(createValidationIssue("MULTIPLE_EVENT_TAGS" /* MULTIPLE_EVENT_TAGS */));
    }
    ...
    for (let i = 0; i < this.proofs.length; i++) {
      ...
      try {
        ...
        if (Array.isArray(payload) && payload[0] === "P2PK" && payload[1]) {
          ...
          if (!tags) {
            issues.push(
              createValidationIssue("MISSING_SENDER_TAG_IN_PROOF" /* MISSING_SENDER_TAG_IN_PROOF */, i)
            );
          } else {
        ...
        issues.push(
          createValidationIssue("MALFORMED_PROOF_SECRET" /* MALFORMED_PROOF_SECRET */, i)
        );
      }
    }
    if (!eventId && this.proofs.length > 0) {
      issues.push(createValidationIssue("NO_EVENT_TAG_IN_EVENT" /* NO_EVENT_TAG_IN_EVENT */));
    }
    const hasErrors = issues.some((issue) => issue.severity === "ERROR" /* ERROR */);
    return {
      valid: !hasErrors,
      issues
    };
...
// src/events/kinds/relay-feed-list.ts
var NDKRelayFeedList = class _NDKRelayFeedList extends NDKList {
  static kind = 10012 /* RelayFeedList */;
  static kinds = [10012 /* RelayFeedList */];
  constructor(ndk, rawEvent) {
    super(ndk, rawEvent);
    if (!rawEvent?.kind) {
      this.kind = 10012 /* RelayFeedList */;
    }
  }
  static from(ndkEvent) {
...
var NDKRepost = class _NDKRepost extends NDKEvent {
  _repostedEvents;
  static kind = 6 /* Repost */;
  static kinds = [6 /* Repost */, 16 /* GenericRepost */];
  static from(event) {
...
var NDKSubscriptionReceipt = class _NDKSubscriptionReceipt extends NDKEvent {
  debug;
  static kind = 7003 /* SubscriptionReceipt */;
...
function filterForEventsTaggingId(id) {
  try {
    const decoded = import_nostr_tools4.nip19.decode(id);
    switch (decoded.type) {
      case "naddr":
        return {
...
function filterFromId(id) {
  ...
  if (id.match(BECH32_REGEX)) {
    try {
      decoded = import_nostr_tools4.nip19.decode(id);
      switch (decoded.type) {
        case "nevent": {
...
function relaysFromBech32(bech322, ndk) {
  try {
    const decoded = import_nostr_tools4.nip19.decode(bech322);
...
var NDKUser = class _NDKUser {
  ...
  constructor(opts) {
    ...
    if (opts.nprofile) {
      try {
        const decoded = import_nostr_tools5.nip19.decode(opts.nprofile);
...
var NDKPrivateKeySigner = class _NDKPrivateKeySigner {
  ...
  constructor(privateKeyOrNsec, ndk) {
    if (typeof privateKeyOrNsec === "string") {
      if (privateKeyOrNsec.startsWith("nsec1")) {
        const { type, data } = import_nostr_tools6.nip19.decode(privateKeyOrNsec);
        if (type === "nsec") this._privateKey = data;
        else throw new Error("Invalid private key provided.");
      } else if (privateKeyOrNsec.length === 64) {
        this._privateKey = (0, import_utils3.hexToBytes)(privateKeyOrNsec);
      } else {
    ...
    this._pubkey = (0, import_nostr_tools6.getPublicKey)(this._privateKey);
  ...
  get nsec() {
    if (!this._privateKey) throw new Error("Not ready");
    return import_nostr_tools6.nip19.nsecEncode(this._privateKey);
  }
  /**
  ...
  get npub() {
    if (!this._pubkey) throw new Error("Not ready");
    return import_nostr_tools6.nip19.npubEncode(this._pubkey);
  }
  /**
  ...
  async encrypt(recipient, value, scheme) {
    ...
    if (scheme === "nip44") {
      const conversationKey = import_nostr_tools6.nip44.v2.utils.getConversationKey(this._privateKey, recipientHexPubKey);
  ...
  async decrypt(sender, value, scheme) {
    ...
    if (scheme === "nip44") {
      const conversationKey = import_nostr_tools6.nip44.v2.utils.getConversationKey(this._privateKey, senderHexPubKey);
...
function getRumorEvent(event, kind) {
  ...
  rumor.sig = void 0;
  rumor.id = (0, import_nostr_tools7.getEventHash)(rumor);
...
var NDKInterestList = class _NDKInterestList extends NDKEvent {
  static kind = 10015 /* InterestList */;
  static kinds = [10015 /* InterestList */];
  constructor(ndk, rawEvent) {
    super(ndk, rawEvent);
...
// src/events/kinds/zap.ts
var NDKZap = class _NDKZap extends NDKEvent {
  static kind = 9735 /* Zap */;
  static kinds = [9735 /* Zap */];
  _invoice;
  constructor(ndk, rawEvent) {
    super(ndk, rawEvent);
    this.kind ??= 9735 /* Zap */;
   ...
   */
  static from(event) {
    if (event.kind !== 9735 /* Zap */) return null;
...
// src/events/kinds/voice-message.ts
var NDKVoiceMessage = class _NDKVoiceMessage extends NDKEvent {
  static kind = 1222 /* VoiceMessage */;
  static kinds = [1222 /* VoiceMessage */];
  constructor(ndk, rawEvent) {
    super(ndk, rawEvent);
    this.kind ??= 1222 /* VoiceMessage */;
  }
  /**
...
var NDKVoiceReply = class _NDKVoiceReply extends NDKEvent {
  static kind = 1244 /* VoiceReply */;
  static kinds = [1244 /* VoiceReply */];
  constructor(ndk, rawEvent) {
    super(ndk, rawEvent);
    this.kind ??= 1244 /* VoiceReply */;
  }
  /**
...
var OutboxTracker = class extends import_tseep5.EventEmitter {
  data;
  ndk;
  debug;
  constructor(ndk) {
...
var import_typescript_lru_cache3 = require("typescript-lru-cache");
...
var debug6 = (0, import_debug7.default)("ndk:active-user");
...
function getEntity(entity) {
  try {
    const decoded = import_nostr_tools9.nip19.decode(entity);
...
var NDK = class extends import_tseep6.EventEmitter {
  _explicitRelayUrls;
  pool;
  outboxPool;
  _signer;
  ...
  getUser(opts) {
    if (typeof opts === "string") {
      if (opts.startsWith("npub1")) {
        const { type, data } = import_nostr_tools10.nip19.decode(opts);
  ...
  async fetchUser(input, skipCache = false) {
    if (isValidNip05(input)) {
      ...
      const { type, data } = import_nostr_tools10.nip19.decode(input);
...
// src/nip19/index.ts
var nip19_exports = {};
__reExport(nip19_exports, require("nostr-tools/nip19"));

// src/nip49/index.ts
var nip49_exports = {};
__reExport(nip49_exports, require("nostr-tools/nip49"));
...
// src/signers/nip46/backend/switch-relays.ts
...
var NDKNip46Backend = class {
  ...
  constructor(ndk, privateKeyOrSigner, permitCallback, relayUrls) {
    ...
    if (privateKeyOrSigner instanceof Uint8Array) {
      ...
      this.signer = new NDKPrivateKeySigner((0, import_utils6.hexToBytes)(privateKeyOrSigner));
